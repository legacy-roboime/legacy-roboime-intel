...
Joints::Joints(NxScene* scene)
{
	this->scene = scene;
}

NxFixedJoint* Joints::CreateFixedJoint(NxActor* a0, NxActor* a1, const NxVec3& globalAnchor, const NxVec3& globalAxis)
{
	...
	return static_cast<NxFixedJoint*>(scene->createJoint(fixedDesc));
}

NxRevoluteJoint* Joints::CreateRevoluteJoint(NxActor* a0, NxActor* a1, const NxVec3& globalAnchor, const NxVec3& globalAxis)
{
	...
	return static_cast<NxRevoluteJoint*>(scene->createJoint(revDesc));
}

NxSphericalJoint* Joints::CreateSphericalJoint(NxActor* a0, NxActor* a1, const NxVec3& globalAnchor, const NxVec3& globalAxis)
{
	...
	return static_cast<NxSphericalJoint*>(scene->createJoint(sphericalDesc));
}

NxPrismaticJoint* Joints::CreatePrismaticJoint(NxActor* a0, NxActor* a1, const NxVec3& globalAnchor, const NxVec3& globalAxis)
{
	...
	NxJoint* joint = scene->createJoint(prismaticDesc);
...
NxCylindricalJoint* Joints::CreateCylindricalJoint(NxActor* a0, NxActor* a1, const NxVec3& globalAnchor, const NxVec3& globalAxis)
{
	...
	NxJoint* joint = scene->createJoint(cylDesc);

	return static_cast<NxCylindricalJoint*>(joint);
}

NxPointOnLineJoint* Joints::CreatePointOnLineJoint(NxActor* a0, NxActor* a1, const NxVec3& globalAnchor, const NxVec3& globalAxis)
{
	...
	NxJoint* joint = scene->createJoint(polDesc);

	return static_cast<NxPointOnLineJoint*>(joint);
}

NxPointInPlaneJoint* Joints::CreatePointInPlaneJoint(NxActor* a0, NxActor* a1, const NxVec3& globalAnchor, const NxVec3& globalAxis)
{
	...
	NxJoint* joint = scene->createJoint(pipDesc);

	return static_cast<NxPointInPlaneJoint*>(joint);
}

NxSphericalJoint* Joints::CreateRopeSphericalJoint(NxActor* a0, NxActor* a1, const NxVec3& globalAnchor, const NxVec3& globalAxis)
{
	NxSphericalJointDesc sphericalDesc;
	sphericalDesc.actor[0] = a0;
	sphericalDesc.actor[1] = a1;
...
NxSphericalJoint* Joints::CreateClothSphericalJoint(NxActor* a0, NxActor* a1, const NxVec3& globalAnchor, const NxVec3& globalAxis)
{
	NxSphericalJointDesc sphericalDesc;
	sphericalDesc.actor[0] = a0;
	sphericalDesc.actor[1] = a1;
...
NxSphericalJoint* Joints::CreateBodySphericalJoint(NxActor* a0, NxActor* a1, const NxVec3& globalAnchor, const NxVec3& globalAxis)
{
	NxSphericalJointDesc sphericalDesc;
	sphericalDesc.actor[0] = a0;
	sphericalDesc.actor[1] = a1;
...
NxRevoluteJoint* Joints::CreateWheelJoint(NxActor* a0, NxActor* a1, const NxVec3& globalAnchor, const NxVec3& globalAxis)
{
	NxRevoluteJointDesc revDesc;
	revDesc.actor[0] = a0;
	revDesc.actor[1] = a1;
...
NxRevoluteJoint* Joints::CreateStepJoint(NxActor* a0, NxActor* a1, const NxVec3& globalAnchor, const NxVec3& globalAxis)
{
	NxRevoluteJointDesc revDesc;
	revDesc.actor[0] = a0;
	revDesc.actor[1] = a1;
...
NxRevoluteJoint* Joints::CreateChassisJoint(NxActor* a0, NxActor* a1, const NxVec3& globalAnchor, const NxVec3& globalAxis)
{
	NxRevoluteJointDesc revDesc;
	revDesc.actor[0] = a0;
	revDesc.actor[1] = a1;
...
NxFixedJoint* Joints::CreateCannonJoint(NxActor* a0, NxActor* a1, const NxVec3& globalAnchor, const NxVec3& globalAxis)
{
	...
	return static_cast<NxFixedJoint*>(scene->createJoint(fixDesc));
}

NxSphericalJoint* Joints::CreateBladeLink(NxActor* a0, NxActor* a1, const NxVec3& globalAnchor, const NxVec3& globalAxis)
{
	NxSphericalJointDesc sphericalDesc;
	sphericalDesc.actor[0] = a0;
	sphericalDesc.actor[1] = a1;
