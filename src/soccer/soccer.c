...
//static float goal_covering( SoccerState *s );//never used, uncomment if needed
//static float goal_distance( SoccerState *s );//never used, uncomment if needed
...
float sstate_evaluate( SoccerState *s )
{
 ...
 float min_red_dist_to_ball,// min_red_dist_to_blue_goal,//never used, uncomment if needed
       min_red_dist_to_red_goal;
 float min_blue_dist_to_ball,  min_blue_dist_to_blue_goal;//,
       //min_blue_dist_to_red_goal;//never used, uncomment if needed
...
// min_red_dist_to_blue_goal = sstate_min_red_dist( s, blue_goal );//never used, uncomment if needed
...
// min_blue_dist_to_red_goal = sstate_min_blue_dist( s, red_goal );//never used, uncomment if needed
...
//    s5 = 300*MAX(min_blue_dist_to_ball,3);//never used, uncomment if needed
// else
//    s5 = 900;//never used, uncomment if needed
